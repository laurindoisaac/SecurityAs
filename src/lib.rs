// src/lib.rs
/*
 * Core library for SecurityAsCode
 */
...
#[derive(Debug)]
pub struct SecurityAsCodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SecurityAsCodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SecurityAsCode processing");
    
    let mut processor = SecurityAsCodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SecurityAsCodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SecurityAsCodeProcessor::new(false);
